...
return null;var bytes=[];for(var i=0;i<s.length;i++){var ch=s.charCodeAt(i);if(ch>=0xD800&&ch<=0xDBFF&&i+1<s.length){const next=s.charCodeAt(i+1);if(next>=0xDC00&&next<=0xDFFF){ch=0x10000+((ch-0xD800)<<10)+(next-0xDC00);i++;}}
if(ch<=0x7F)
